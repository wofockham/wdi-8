...
require_relative './wordy_calculator_four'
...
class WordProblemTest < MiniTest::Test
  ...
  def test_multiple_pluses
    # skip
    question = 'What is 4 plus 12 plus 16 plus 8?'
    assert_equal 40, WordProblem.new(question).answer
  end

  def test_lots_of_operations
    # skip
    question = 'What is 10 minus 6 plus 22 plus 8 plus 10 minus 6?'
    assert_equal 38, WordProblem.new(question).answer
  end
